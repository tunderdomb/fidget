...
module.exports = function register( definition ){
  ...
  if( definition.createdCallback ) proto.createdCallback = definition.createdCallback
  if( definition.attachedCallback ) proto.attachedCallback = definition.attachedCallback
  if( definition.detachedCallback ) proto.detachedCallback = definition.detachedCallback
  if( definition.attributeChangedCallback ) proto.attributeChangedCallback = definition.attributeChangedCallback
