...
module.exports = function register( definition ){
  ...
  proto.attachedCallback = attached(definition["attributeChangedCallback"], inherit)
  proto.detachedCallback = detached(definition["attributeChangedCallback"], inherit)
