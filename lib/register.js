...
module.exports = function register( definition ){
  ...
  var handleAttributeChange = createAttributes(proto, attributes)
  proto.dispatch = createDispatcher(events)
  proto.initialize = function(  ){
    initializedCallback.apply(this, arguments)
    return this
  }
  ...
  proto.attributeChangedCallback = function( name, previousValue, value ){
    ...
    if( typeof definition.attributeChangedCallback == "function" ) {
