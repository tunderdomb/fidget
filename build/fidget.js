...
module.exports = function createAttributes( elementName, inherits, proto, attributes ){
  ...
  for( var name in attributes ){
    if( attributes.hasOwnProperty(name) ){
      def = attributes[name]
      proto[camelCase(name)] = defineAttribute(name, def, attrManager)
    }
  }
...
},{"../util/extend":13,"./defineAttribute":7,"camelcase":12}],4:[function(require,module,exports){
...
module.exports = function defineAttribute( name, def, attributeManager ){
  ...
  var simpleDef = typeOfDef != "object" // the definition is a primitive, not a config object
  var type = simpleDef
